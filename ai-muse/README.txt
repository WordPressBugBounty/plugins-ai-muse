...
## OpenAI Support
AI Muse Plugin Supports OpenAI’s latest and greatest models. Dall-E, GPT-4 and GPT-3.5 are supported out of the box. [OpenAI Support](https://wpaimuse.com/docs/features/openai-support/ "OpenAI Support")
